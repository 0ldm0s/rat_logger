use rat_logger::{LoggerBuilder, LevelFilter, FileConfig, CompositeHandler, FileHandler, Logger};
...
// 创建应用日志记录
fn create_app_record(message: String) -> rat_logger::config::Record {
...
// 创建错误日志记录
fn create_error_record(message: String) -> rat_logger::config::Record {
    rat_logger::config::Record {
        metadata: std::sync::Arc::new(rat_logger::config::Metadata {
...
// 创建访问日志记录
fn create_access_record(message: String) -> rat_logger::config::Record {
    rat_logger::config::Record {
        metadata: std::sync::Arc::new(rat_logger::config::Metadata {
            level: rat_logger::config::Level::Info,
...
// 创建性能日志记录
fn create_perf_record(message: String) -> rat_logger::config::Record {
    rat_logger::config::Record {
        metadata: std::sync::Arc::new(rat_logger::config::Metadata {
